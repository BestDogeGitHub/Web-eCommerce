...
class StaticTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $carriers = [            
            [ 'id' => 1, 'name' => 'United Parcel Service', 'image_ref' => '\images\UPS_logo.png', 
            ...
            [ 'id' => 2, 'name' => 'FedEx', 'image_ref' => '\images\FedEx_logo.svg.png', 
            ...
            [ 'id' => 3, 'name' => 'XPO Logistics', 'image_ref' => '\images\XPO_logo.svg.png', 
            ...
            [ 'id' => 4, 'name' => 'J. B. Hunt', 'image_ref' => '\images\Hunt_logo.svg.png', 
            ...
            [ 'id' => 5, 'name' => 'Knight-Swift', 'image_ref' => '\images\Knight-Swift_logo.png', 
            ...
            [ 'id' => 6, 'name' => 'YRC Worldwide', 'image_ref' => '\images\YRC_logo.svg.png', 
        ...
        $producers = [
            [ 'id' => 1, 'name' => 'Gibson', 'image_ref' => '\images\Gibson_logo.jpg', 
            'link' => 'gibson.com', 'details' => 'Gibson Brands, Inc. (formerly Gibson Guitar Corporation) is an American manufacturer of guitars, other musical instruments, and professional audio equipment from Kalamazoo, Michigan, and now based in Nashville, Tennessee. The company was formerly known as Gibson Guitar Corporation and renamed Gibson Brands, Inc. on June 11, 2013.' ],
            [ 'id' => 2, 'name' => 'Shure', 'image_ref' => '\images\Shure_logo.png', 
            ...
            [ 'id' => 3, 'name' => 'Yamaha Corporation', 'image_ref' => '\images\Yamaha_logo.jpg', 
            ...
            [ 'id' => 4, 'name' => 'Fender Musical Instruments Corporation', 'image_ref' => '\images\Fender_guitars_logo.svg.png', 
            ...
            [ 'id' => 5, 'name' => 'Steinway Musical Instruments', 'image_ref' => '\images\Steinway_logo.svg.png', 
            ...
            [ 'id' => 6, 'name' => 'Sennheiser', 'image_ref' => '\images\Sennheiser_logo.jpg', 
            ...
            [ 'id' => 7, 'name' => 'Roland Corporation', 'image_ref' => '\images\Roland_logo.svg.png', 
