...
class StaticTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $carriers = [            
            ...
            [ 'id' => 3, 'name' => 'XPO Logistics', 'image_ref' => '/images/carriers/XPO_logo.svg.png', 
        ...
        $producers = [
            ...
            [ 'id' => 9, 'name' => 'DigiTech ', 'image_ref' => '/images/producers/Logo-DigiTech_logo.svg.png', 
            'link' => 'www.digitech.com/', 'details' => 'DigiTech is an American company which manufactures digital effects units.' ],
            [ 'id' => 10, 'name' => 'TC Electronic', 'image_ref' => '/images/producers/logo-tc-electronic.jpg', 
            'link' => 'www.tcelectronic.com/', 'details' => 'TC Electronic is a Danish audio equipment company that designs and imports guitar effects, bass amplification, computer audio interfaces, audio plug-in software, live sound equalisers, studio and post production equipment, studio effect processors, and broadcast loudness processors and meters.' ],
            [ 'id' => 11, 'name' => 'Proel', 'image_ref' => '/images/producers/logo_proel.png', 
            'link' => 'www.proel.com/', 'details' => 'In 1997, PROEL was already a well-organised company and decided that a key step to be taken was to create a “Made in Italy” Research, Design and Prototyping department. What was puIn 1998, the drummers arrived and everything became a bit more lively. PROEL acquires the historic Tamburo Drums brand.'],
            [ 'id' => 12, 'name' => 'Sagitter', 'image_ref' => '/images/producers/logo sagiiter.png', 
            'link' => 'www.sagitter.com/', 'details' => 'Founded in 1992, Sagitter was created by one of the original founders of Clay Paky Lighting company.
