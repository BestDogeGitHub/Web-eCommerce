						...
						<div class="carousel-testimony owl-carousel">
							...
							<div class="item">
								<div class="testimony-wrap p-4 pb-5">
									<img src="{{ asset($testimony->image_ref) }}" class="user-img mb-5 test" />
									<div class="text text-center">
										<p class="mb-5 pl-4 line">{{ $testimony->text }}</p>
										<p class="name">{{ $testimony->user }}</p>
										<p class="position">{{ $testimony->man }}</p>
									</div>
								</div>
							</div>
							@empty
