    	...
    	<div class="container">
    		<div class="row">
    			<div class="col-lg-6 mb-5 ftco-animate">
    				<a href="{{ asset('images/product-1.jpg') }}" class="image-popup"><img src="{{ asset('{{ $product->images->image_ref }}') }}" class="img-fluid" alt="Colorlib Template"></a>
    			</div>
    			<div class="col-lg-6 product-details pl-md-5 ftco-animate">
    				<h3>Prodotto {{ $product->id }}</h3>
