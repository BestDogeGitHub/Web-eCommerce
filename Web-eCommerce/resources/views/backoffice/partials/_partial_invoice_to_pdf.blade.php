  ...
  <body>
    <div class="container invoice-container">
        ...
        <div class="row">
            ...
            <div class="col">
            <h4>Ship In</h4>
            <p>Town: <b>{{$invoice->order->user->address->town->name}}</b> <i>(POSTCODE {{$invoice->order->user->address->postcode}})</i><br/>Nation: <b>{{$invoice->order->user->address->town->nation->name}}</b>.<br/>
            Street <b>{{$invoice->order->user->address->street_number}}</b>, Building <b>{{$invoice->order->user->address->building_number}}</b> ({{$invoice->order->user->address->country_code}}).</p>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col">
            <h4>Invoice Total <i class="total">&euro; {{ $invoice->payment }}</i></h4>
            </div>
            <div class="col">
        </div>
    </div>
